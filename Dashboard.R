...
setwd("D:/User/Google Drive/Proyectos/Trabajo/Empresas Full Time/Applications/Nike/Code/")
...
header <- dashboardHeader(title = "Dashboard - NIKE Revenues (2020)")  
...
server <- function(input, output) { 
  ...
  output$value1 <- renderValueBox({
    valueBox(
      ...
      ,paste('Top:',sales.account$Account)
